...
@Component({
  selector: 'app-enviar-comite-dialog',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './enviar-comite-dialog.component.html',
  styleUrl: './enviar-comite-dialog.component.scss'
})
export class EnviarComiteDialogComponent implements OnInit {
