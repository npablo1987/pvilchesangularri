...
@Component({
  selector: 'app-priorizacion-orden-dialog',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './priorizacion-orden-dialog.component.html',
  styleUrl: './priorizacion-orden-dialog.component.scss'
})
export class PriorizacionOrdenDialogComponent implements OnInit {
