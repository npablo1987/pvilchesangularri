...
@Component({
  selector: 'app-evaluacion-tab-estudio',
  standalone: true,
  imports: [
    CommonModule,
    ButtonModule,
  ...
  templateUrl: './evaluacion-tab-estudio.component.html',
  styleUrl: './evaluacion-tab-estudio.component.scss'
})
export class EvaluacionTabEstudioComponent implements OnInit {
